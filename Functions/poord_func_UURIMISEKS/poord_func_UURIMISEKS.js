...
function setup() {
  ...
  tekst_joonisel = createP("Funktsiooni &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp &nbsp  &nbsp  graafik.");
  tekst_joonisel.position(width/3, height+80);
...
function draw() {
  ...
  LaTeX_string="y="+"\\dfrac{ "+str(slider1.value())+" }{x}"+vabaliige;
