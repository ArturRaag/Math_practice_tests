...
function draw() {
  ...
  tex_võrrand.position(width/asukoha_nr+0,height/asukoha_nr+80)
...
function Ylesanne(){
  ...
  murru_numbriline_väärtus=round_3(lugeja_laiendamata/nimetaja_laiendamata);
...
function kontroll(){
  ...
  if(typeof float(murru_vastus.value()) == 'number' && !isNaN(float(murru_vastus.value())) ){
           if (murru_vastus.value() == murru_numbriline_väärtus){
              tulemus.html("Õige!");
