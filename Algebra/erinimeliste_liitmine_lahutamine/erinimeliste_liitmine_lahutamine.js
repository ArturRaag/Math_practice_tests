...
function Ylesanne(){
  ...
  // console.log(märgi_valik)
  // console.log(märk_numbriline)
  // console.log(lugeja_vastus, nimetaja_vastus, laiendaja)
  
  vastus_kontrollimiseks = ((lugeja_murrus_1* nimetaja_murrus_2)+märk_numbriline*(lugeja_murrus_2* nimetaja_murrus_1) )/(nimetaja_murrus_1*nimetaja_murrus_2)
  
  
  tex_string="\\dfrac{"+str(lugeja_murrus_1)+"}{"+str(nimetaja_murrus_1 )+"}"+str(märgi_valik)+"\\dfrac{"+str(lugeja_murrus_2)+ "}{"+str(nimetaja_murrus_2)+"}= \\dfrac{ \\hspace{10mm}}{\\hspace{10mm}}";
