...
function Ylesanne(){
  ...
  vastus_kontrollimiseks = (lugeja_murrus_1+märk_numbriline*lugeja_murrus_2)/(nimetaja_murrus_1);
  
  
  tex_string="\\dfrac{"+str(lugeja_murrus_1)+"}{"+str(nimetaja_murrus_1 )+"}"+str(märgi_valik)+"\\dfrac{"+str(lugeja_murrus_2)+ "}{"+str(nimetaja_murrus_1)+"}= \\dfrac{ \\hspace{10mm}}{\\hspace{10mm}}";
